 ...
 */
function meddox_merlin_import_files() {
	return array(
		array(
			...
			'import_notice'                => esc_html__( 'A special note for this import.', 'meddox' ),
			'preview_url'                  => '//www.example.com/my-demo-1',
		)
	);
}
add_filter( 'merlin_import_files', 'meddox_merlin_import_files' );
