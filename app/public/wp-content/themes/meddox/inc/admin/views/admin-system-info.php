<?php 
	...
	function pxl_get_system_info() {
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Upload max file size (64MB)', 'meddox' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Memory limit (256MB)', 'meddox' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Post max size (64MB)', 'meddox' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Max Execution Time (6s)', 'meddox' ),
	    ...
	    array_push(
	        $system_info,
	        [
	            'title' => esc_attr__( 'Max input vars (3000)', 'meddox' ),
	...
	?>
		<div class="pxl-iconbox">
			<div class="pxl-icon-container">
				...
				<?php else : ?>
					<img src="<?php echo get_template_directory_uri() . '/inc/admin/assets/img/crossed.png' ?>" alt="<?php esc_attr_e( 'Un Check', 'meddox' ); ?>">
				<?php endif; ?>
			</div>
