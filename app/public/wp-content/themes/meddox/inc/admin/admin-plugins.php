...
class Meddox_Admin_Plugins extends Meddox_Admin_Page {
	protected $id = null;
	...
	public function __construct() {
		...
		$this->page_title = esc_html__( 'Install Plugins', 'meddox' );
		$this->menu_title = esc_html__( 'Install Plugins', 'meddox' );
		$this->parent = 'pxlart';
	...
	public function tgmpa_plugin_action( $plugin, $status ) {
		...
		switch( $status ) {
			case 'not-installed':
			$btn_class = 'white';
			$btn_text = esc_html_x( 'Install', 'Plugin installation page.', 'meddox' );
			...
			case 'installed':
			$btn_class = 'success';
			$btn_text = esc_html_x( 'Activate', 'Plugin installation page.', 'meddox' );
			...
			case 'active':
			$btn_class = 'danger';
			$btn_text = esc_html_x( 'Deactivate', 'Plugin installation page.', 'meddox' );
		...
		$btn_text_active = esc_html_x( 'Deactivate', 'Plugin installation page.', 'meddox' );
