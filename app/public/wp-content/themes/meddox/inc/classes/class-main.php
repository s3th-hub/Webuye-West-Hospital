...
if (!class_exists('meddox_Main')) { 
    class meddox_Main extends meddox_Base
    {
...
function meddox() {
    return meddox_Main::getInstance();
}
// Install
meddox(); 
