...
pxl_add_custom_widget(
    array(
        'name' => 'pxl_care_grid',
        'title' => esc_html__('Pxl Care Grid', 'meddox'),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elements/templates/pxl_care_grid/layout-image/layout1.jpg'
                                ], 
                ...
                array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'selectors' => [
                                '{{WRAPPER}} .pxl-care-grid .pxl-item--title' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .pxl-care-grid .pxl-item--title',
                        ),
                        array(
                            'name' => 'pos_color',
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-care-grid .pxl-item--position' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            'name' => 'pos_typography',
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .pxl-care-grid .pxl-item--position',
                        ),
                        array(
                            'name' => 'desc_color',
                            ...
                            'type' => \Elementor\Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}} .pxl-care-grid .pxl-item--description' => 'color: {{VALUE}};',
                            ],
                        ),
                        array(
                            ...
                            'type' => \Elementor\Group_Control_Typography::get_type(),
                            'control_type' => 'group',
                            'selector' => '{{WRAPPER}} .pxl-care-grid .pxl-item--description',
                        ),
                    ),
                ),
            ),
