...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Pxl Team Carousel', 'meddox'),
        ...
        'params' => array(
            'sections' => array(
                    ...
                    'controls' => array(
                        array(
                            ...
                            'controls' => array(
                                ...
                                array(
                                    'name' => 'social',
                                    'label' => esc_html__( 'Social', 'meddox' ),
                                    'type' => 'pxl_icons',
                                ),
                                array(
                                    'name' => 'bg_teamcr_color',
                                    'label' => esc_html__('Background Color', 'meddox' ),
                                    'type' => \Elementor\Controls_Manager::COLOR,
                                    'selectors' => [
                                        '{{WRAPPER}} {{CURRENT_ITEM}}  .pxl-item--meta:before' => 'background-color: {{VALUE}};',
                                        '{{WRAPPER}} {{CURRENT_ITEM}}  .pxl-item--meta:after' => 'background-color: {{VALUE}};',
                                        '{{WRAPPER}} {{CURRENT_ITEM}}  .pxl-item--inner2' => 'background-color: {{VALUE}};',
                                    ],
                                ),
                            ),
                            'title_field' => '{{{ title }}}',
                ...
                array(
                    ...
                    'label' => esc_html__('Carousel Settings', 'meddox'),
                    ...
                    'controls' => array(
                        ...
                        array(
                            'name' => 'dots',
                            'label' => esc_html__('Show Dots', 'meddox'),
                            'type' => \Elementor\Controls_Manager::SWITCHER,
                        ),
                        array(
                            'name' => 'pause_on_hover',
