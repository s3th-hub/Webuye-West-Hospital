...
pxl_add_custom_widget(
    array(
        ...
        'title' => esc_html__('Pxl Icon Box Carousel', 'meddox'),
        'icon' => 'eicon-carousel',
...
array(
    ...
    'label' => esc_html__('Settings', 'meddox'),
    ...
    'controls' => array(
        ...
        array(
            'name' => 'vertical',
            'label' => esc_html__('Vertical', 'meddox'),
            'type' => \Elementor\Controls_Manager::SWITCHER,
        ),
        array(
            'name' => 'autoplay',
