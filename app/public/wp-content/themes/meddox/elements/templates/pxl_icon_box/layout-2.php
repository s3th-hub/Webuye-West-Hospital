<div class="pxl-icon-box pxl-icon-box2 pxl--widget-hover <?php echo esc_attr($settings['item_active'].' '.$settings['pxl_animate']); ?>" data-wow-delay="<?php echo esc_attr($settings['pxl_animate_delay']); ?>ms">
