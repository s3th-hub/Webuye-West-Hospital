...
if(isset($settings['testimonial']) && !empty($settings['testimonial']) && count($settings['testimonial'])): ?>
    <div class="pxl-swiper-sliders pxl-testimonial-carousel pxl-testimonial-carousel1 pxl-swiper-boxshadow pxl-swiper-arrow-show" data-view-auto="<?php echo esc_attr($col_xl); ?>">
