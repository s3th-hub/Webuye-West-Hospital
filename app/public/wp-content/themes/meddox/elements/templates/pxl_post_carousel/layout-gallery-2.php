...
extract(pxl_get_posts_of_grid('gallery', [
    'source' => $source,
    'orderby' => $orderby,
    'order' => $order,
    'limit' => $limit,
...
<?php if (is_array($posts)): ?>
    <div class="pxl-swiper-sliders pxl-gallery-carousel pxl-gallery-carousel2 pxl-swiper-boxshadow">
        <div class="pxl-carousel-inner">
            <div <?php pxl_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                <div class="pxl-swiper-wrapper">
                    <?php
                    $image_size = !empty($img_size) ? $img_size : '430x515';
                    

                    foreach ($posts as $post):
                        $gallery_icon_font = get_post_meta($post->ID, 'gallery_icon_font', true);
                        ...
                        <div class="pxl-swiper-slide">
                            ...
                            <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>" class="pxl-wrap-link-to-detail"></a>
                        ...
                        <div class="pxl-item--holder">
                            <a class="pxl-item-icon" href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                <i class="flaticon_meddox2 flaticon_meddox2-right-up"></i>
                            </a>
                            ...
                            <?php if($show_category == 'true') : ?>
                                <div class="pxl-item-category">
                                    <?php the_terms($post->ID, 'gallery-category', '', ', '); ?>
                                </div>
                            <?php endif; ?>
