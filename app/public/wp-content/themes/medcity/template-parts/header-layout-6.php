...
<header id="masthead" class="site-header">
    <div id="site-header-wrap" class="header-layout2 header-layout6 fixed-height <?php if($sticky_on == 1) { echo 'is-sticky'; } ?>">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="site-navigation">
                        ...
                        <?php
                        if (($h_btn_on == 'show') || $search_on || (!empty($phone_number)) ){
                            ?>
                            <div class="site-tool">
