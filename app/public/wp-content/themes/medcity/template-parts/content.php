    ...
    <?php else :
        if (has_post_thumbnail()) {
            echo '<div class="entry-featured post-image-wrap"><div class="post-image">'; ?>
                <a href="<?php echo esc_url( get_permalink()); ?>"><?php the_post_thumbnail('medcity-blog'); ?></a>
            <?php echo '</div></div>';
        } ?>
    <?php endif; ?>
    <div class="entry-body">
        <div class="entry-holder">
            <?php medcity_archive_meta(); ?>
        ...
        <div class="entry-readmore">
            <a href="<?php echo esc_url( get_permalink()); ?>" class="btn-text"><?php echo esc_html__('Read More', 'medcity'); ?></a>
        </div>
    </div>
</article><!-- #post -->