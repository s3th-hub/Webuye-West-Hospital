<?php
// Post term options
$post_term_options = etc_get_grid_term_options('department');

// Register Post Grid Widget
etc_add_custom_widget(
    array(
        'name' => 'cms_department_grid',
        'title' => esc_html__('Department Grid', 'medcity' ),
                        ...
                        array(
                            ...
                            'options' => [
                                '1' => [
                                    ...
                                    'image' => get_template_directory_uri() . '/elementor/templates/widgets/cms_department_grid/layout-image/layout1.jpg'
                                ],
                            ],
                        ),
                    ),
