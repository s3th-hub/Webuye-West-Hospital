    ...
    <div id="<?php echo esc_attr($html_id) ?>" class="cms-service-carousel layout1 cms-slick-slider">
        <div <?php etc_print_html($widget->get_render_attribute_string( 'inner' )); ?>>
            <div <?php etc_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                ...
                $service_feature = (array)get_post_meta($post->ID, 'service_feature', true);
                    ...
                    <div class="grid-item-inner">
                        ...
                        <div class="entry-body">
                            ...
                            <div class="entry-readmore">
                                <a class="service-readmore btn" href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><?php echo esc_html__("Read More", 'medcity'); ?> <i class="fac fac-arrow-right"></i></a>
                            </div>
                    </div>
                    </div>
                </div>
