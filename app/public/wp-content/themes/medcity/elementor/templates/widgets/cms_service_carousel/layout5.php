            ...
            <div <?php etc_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
                ...
                <div class="carousel-item">
                    <div class="grid-item-inner">
                        <div class="inner-wrap bg-white bg-hover-tertiary cms-radius-10 cms-shadow-1 cms-transition cms-divider-bottom-tertiary cms-hover-change cms-divider-bottom-hover-tertiary cms-hover-zoom-img overflow-hidden">
                            <?php if (has_post_thumbnail($post->ID) && wp_get_attachment_image_src(get_post_thumbnail_id($post->ID), false)): ?>
                                <a href="<?php echo esc_url(get_permalink( $post->ID )); ?>" class="d-block cms-radius-10 overflow-hidden"><?php 
                                    echo wp_kses_post($thumbnail); 
                                ?></a>
                            <?php endif; ?>
                            <div class="entry-body p-40 text-on-hover-white">
                                <h3 class="entry-title text-on-hover-white text-23 mt-n8 pb-15">
                                ...
                                <div class="entry-readmore mt-32">
                                    <a class="service-readmore cms-btn cms-btn2 cms-btn-outline-btn2 text-btn cms-btn-hover-white text-hover-btn cms-btn-on-hover-primary text-on-hover-white" href="<?php echo esc_url(get_permalink( $post->ID )); ?>">
                                        <?php 
                                            echo esc_html__("Read More", 'medcity');
                                        ?>
                                        <span class="text-12 lh-0"><?php
