...
<?php if (is_array($posts)): ?>
    <div id="<?php echo esc_attr($html_id) ?>" class="cms-doctor-carousel layout1 cms-slick-slider">
                    ...
                    <div class="grid-item-inner">
                        ...
                        <div class="entry-body">
                            ...
                            <div class="entry-readmore">
                                <a class="btn-more" href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><?php echo esc_html__('Read More', 'medcity'); ?><i class="fac fac-arrow-right space-left"></i></a>
                            </div>
                    </div>
                    </div>
                </div>
