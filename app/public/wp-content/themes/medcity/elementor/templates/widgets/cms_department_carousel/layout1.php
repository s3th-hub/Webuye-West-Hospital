...
extract(etc_get_posts_of_grid('department', [
    'source' => $source,
    'orderby' => $orderby,
    'order' => $order,
    'limit' => $limit,
...
$widget->add_render_attribute( 'inner', [
    'class' => 'cms-department-carousel-inner',
] );
...
<?php if (is_array($posts)): ?>
    <div id="<?php echo esc_attr($html_id) ?>" class="cms-department-carousel layout1 cms-slick-slider">
                    ...
                    <div class="grid-item-inner">
                        ...
                        <div class="entry-body">
                            ...
                            <div class="entry-readmore">
                                <a class="btn btn-outline-secondary" href="<?php echo esc_url(get_permalink( $post->ID )); ?>"><?php echo esc_html__("Read More", 'medcity'); ?> <i class="fac fac-arrow-right"></i></a>
                            </div>
                    </div>
                    </div>
                </div>
